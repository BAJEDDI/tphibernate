...
public class ProjetService  implements IDao<Projet> {
    ...
    public List<Projet> getAll() {
       ...
       public void getTachesParProjet(Projet projet) {
...
public void getTachesCompletes(Projet projet) {
        ...
        if (completedTasks.isEmpty()) {
            System.out.println("aucune tache complete dans le projet: " + projet.getNom());
        } else {
