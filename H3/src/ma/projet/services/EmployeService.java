...
public void getProjetsParEmploye(Employe employe) {
 ...
 public  List<EmployeTache> getTacheList(int id) {
    ...
    public void getTachesRealiseParEmploye(Employe employe) {
        ...
        try {
            ...
            Query query = session.getNamedQuery("getTachesRealiseParEmploye");
       ...
       public void getProjetsGeresParEmploye(Employe employe) {
        ...
        try {
            ...
            Query query = session.getNamedQuery("getProjetsGeresParEmploye");
